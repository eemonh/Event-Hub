...
function renderExploreActions(eventId, isOwner, isRegistered, isSaved, onRegister, onBookmark) {
  return (
    <>
      {isOwner ? (
...
function renderMyEventsActions(eventId, isPast, onCancel) {
  if (isPast) {
    return (
...
function renderSavedActions(eventId, isOwner, isRegistered, isSaved, onRemoveBookmark, onRegister) {
  return (
    <>
      {isOwner ? (

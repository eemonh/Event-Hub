  ...
  return (
    <div className="flex flex-col gap-1 pt-1">
      <div className="flex items-center gap-2">
        ...
        />
        <p
          className={`text-[13px] leading-tight font-['Poppins'] ${hasMinLength ? "text-green-600" : "text-slate-500"}`}
        >
      ...
      <div className="flex items-center gap-2">
        ...
        />
        <p
          className={`text-[13px] leading-tight font-['Poppins'] ${hasSpecialChar ? "text-green-600" : "text-slate-500"}`}
        >

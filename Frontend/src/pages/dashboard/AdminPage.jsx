      ...
      <div className="bg-white border border-gray-200 rounded-2xl shadow-sm overflow-hidden">
                ...
                return (
                  ...
                  >
                    <td className="px-6 py-4 flex items-center">
                      <div
                        className={`p-2.5 rounded-xl mr-4 ${event.iconColor}`}
                      >
                    ...
                    <td className="px-6 py-4">
                      <span
                        className={`inline-flex items-center px-2.5 py-1 rounded-full text-xs font-bold ${event.statusColor}`}
                      >
                        {event.status}
                      </span>
                    </td>
        ...
        <div className="px-6 py-4 border-t border-gray-100 flex justify-between items-center text-sm text-gray-500">
          <div>
            ...
            <span className="font-semibold text-gray-700">3</span> of{" "}
            <span className="font-semibold text-gray-700">24</span> entries
          </div>
